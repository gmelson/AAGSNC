...
WebSocket: {"": "EventTarget;protocol=",
  send$1: function(receiver, data) {
    return receiver.send(data);
  },
  "%": "WebSocket"
...
main: function() {
  ...
  t3._tryResume$0();
  t3 = document.querySelector("#cardidentifier_text_id");
  t3.toString;
  t2 = new W._ElementEventStreamImpl(t3, t2, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = client.get$getcard();
...
PersoClient: {"": "Object;connectPending,webSocket",
  connect$0: function() {
    this.connectPending = false;
    this.webSocket = W.WebSocket_WebSocket("ws://127.0.0.1:12345/perso", null);
    var t1 = this.webSocket;
    t1.toString;
    t1 = new W._EventStream(t1, C.EventStreamProvider_open._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t1.get$first(t1).then$1(new X.PersoClient_connect_closure(this));
    t1 = this.webSocket;
    t1.toString;
    t1 = new W._EventStream(t1, C.EventStreamProvider_error._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t1.get$first(t1).then$1(new X.PersoClient_connect_closure0(this));
  },
  get$connect: function() {
    return new P.BoundClosure$0(this, X.PersoClient.prototype.connect$0, null, "connect$0");
  },
  onConnected$0: function() {
    var t1, t2;
    t1 = this.webSocket;
    t1.toString;
    t1 = new W._EventStream(t1, C.EventStreamProvider_message._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.PersoClient_onConnected_closure(this)), t1._useCapture);
  ...
  onDisconnected$0: function() {
    ...
    P.Timer_Timer(C.Duration_500000, this.get$connect());
  },
  onMessage$1: function(_, data) {
    var response, t1, cardperso, cardidentifier, tbody, t2, persod, tr, t3, t4, t5, t6;
    response = C.C_JsonCodec.decode$1(C.C_JsonCodec.decode$1(data));
    t1 = J.getInterceptor$asx(response);
    cardperso = t1.$index(response, "cardperso");
    if (cardperso != null && J.$index$asx(cardperso, 0) != null) {
      t1 = J.getInterceptor$asx(cardperso);
      cardidentifier = J.$index$asx(t1.$index(cardperso, 0), "cardidentifier");
      document.querySelector("#cardidentifier_text_id").textContent = cardidentifier;
      document.querySelector("#description_text_id").textContent = J.$index$asx(t1.$index(cardperso, 0), "description");
    } else {
      cardperso = t1.$index(response, "additionalParams");
      if (cardperso != null) {
        tbody = document.querySelector("#results");
        t1 = J.getInterceptor$x(tbody);
        t2 = t1.get$children(tbody);
        t2.clear$0(t2);
        for (t2 = J.get$iterator$ax(cardperso); t2.moveNext$0();) {
          persod = t2.get$current();
          tr = document.createElement("tr", null);
          t3 = J.getInterceptor$x(tr);
          t4 = t3.get$children(tr);
          t5 = document.createElement("td", null);
          t6 = J.getInterceptor$asx(persod);
          J.set$innerHtml$x(t5, t6.$index(persod, "name"));
          t4.add$1(t4, t5);
          t3 = t3.get$children(tr);
          t5 = document.createElement("td", null);
          J.set$innerHtml$x(t5, t6.$index(persod, "value"));
          t3.add$1(t3, t5);
          t5 = t1.get$children(tbody);
          t5.add$1(t5, tr);
        }
        $.get$context().callMethod$2("reloadgrid", []);
      }
    }
  },
  startProcess$1: function(e) {
    this.webSocket.send("go");
  },
  get$startProcess: function() {
    return new H.BoundClosure$1(this, X.PersoClient.prototype.startProcess$1, null, "startProcess$1");
  },
  getcard$1: function(e) {
    var message = C.JSString_methods.$add("more:", document.querySelector("#cardidentifier_text_id").textContent);
    this.webSocket.send(message);
  },
  get$getcard: function() {
    return new H.BoundClosure$1(this, X.PersoClient.prototype.getcard$1, null, "getcard$1");
  },
  static: {
"": "PersoClient_RECONNECT_DELAY",
}

},

PersoClient_connect_closure: {"": "Closure;this_0",
  call$1: function(_) {
    var t1, t2;
    t1 = this.this_0;
    t1.onConnected$0();
    ...
    H.setRuntimeTypeInfo(t2, [null]);
    t2.get$first(t2).then$1(new X.PersoClient_connect__closure(t1));
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
PersoClient_connect__closure: {"": "Closure;this_1",
  call$1: function(_) {
    var t1 = this.this_1;
    P.print("Connection disconnected to " + t1.webSocket.url);
    t1.onDisconnected$0();
  },
  "+call:1:0": 0,
  $isFunction: true,
...
PersoClient_connect_closure0: {"": "Closure;this_2",
  call$1: function(_) {
    var t1 = this.this_2;
    P.print("Failed to connect to " + t1.webSocket.url + ". Please run bin/server.dart and try again.");
    t1.onDisconnected$0();
  },
  "+call:1:0": 0,
  $isFunction: true,
...
PersoClient_onConnected_closure: {"": "Closure;this_0",
  call$1: function(e) {
    var t1 = this.this_0;
    t1.onMessage$1(t1, J.get$data$x(e));
  },
  "+call:1:0": 0,
  $isFunction: true,
  $is_args1: true
...
function dart_precompiled($collectedClasses) {
  ...
  function PersoClient(connectPending, webSocket) {
    this.connectPending = connectPending;
    this.webSocket = webSocket;
  }
  PersoClient.builtin$cls = "PersoClient";
  if (!"name" in PersoClient)
    PersoClient.name = "PersoClient";
  $desc = $collectedClasses.PersoClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PersoClient.prototype = $desc;
  function PersoClient_connect_closure(this_0) {
    this.this_0 = this_0;
  }
  PersoClient_connect_closure.builtin$cls = "PersoClient_connect_closure";
  if (!"name" in PersoClient_connect_closure)
    PersoClient_connect_closure.name = "PersoClient_connect_closure";
  $desc = $collectedClasses.PersoClient_connect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PersoClient_connect_closure.prototype = $desc;
  function PersoClient_connect__closure(this_1) {
    this.this_1 = this_1;
  }
  PersoClient_connect__closure.builtin$cls = "PersoClient_connect__closure";
  if (!"name" in PersoClient_connect__closure)
    PersoClient_connect__closure.name = "PersoClient_connect__closure";
  $desc = $collectedClasses.PersoClient_connect__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PersoClient_connect__closure.prototype = $desc;
  function PersoClient_connect_closure0(this_2) {
    this.this_2 = this_2;
  }
  PersoClient_connect_closure0.builtin$cls = "PersoClient_connect_closure0";
  if (!"name" in PersoClient_connect_closure0)
    PersoClient_connect_closure0.name = "PersoClient_connect_closure0";
  $desc = $collectedClasses.PersoClient_connect_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PersoClient_connect_closure0.prototype = $desc;
  function PersoClient_onConnected_closure(this_0) {
    this.this_0 = this_0;
  }
  PersoClient_onConnected_closure.builtin$cls = "PersoClient_onConnected_closure";
  if (!"name" in PersoClient_onConnected_closure)
    PersoClient_onConnected_closure.name = "PersoClient_onConnected_closure";
  $desc = $collectedClasses.PersoClient_onConnected_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PersoClient_onConnected_closure.prototype = $desc;
